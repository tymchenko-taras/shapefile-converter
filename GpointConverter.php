...
/*------------------------------------------------------------------------------
** class GpointConverter		... for Geographic Point
**
...
class GpointConverter
{
    ...
    */
    ...
    // constructor
    function GpointConverter($datum='WGS 84')			// Default datum is WGS 84
    {
    ...
    function setDatum($datum='WGS 84')
    {
        $this->a = $this->ellipsoid[$datum][0];		// Set datum Equatorial Radius
        $this->e2 = $this->ellipsoid[$datum][1];	// Set datum Square of eccentricity
        $this->datum = $datum;						// Save the datum
    ...
    //
    function setLambert($northing, $easting)
    {
...
//
    function convertLLtoTM($LongOrigin)
    {
        $k0 = 0.9996;
        $falseEasting = 0.0;
...
// GpointConverter to another Long/Lat coordinate
//
